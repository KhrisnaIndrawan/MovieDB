...
//
//        Mockito.`when`(movieRepository.getMoviesNowPlaying())
...
//        expectedResult.setValue(moviesEntity)
//
//        Mockito.`when`(movieRepository.getMoviesUpComing())
//            .thenReturn(expectedResult)
//
//        val observer: Observer<MoviesEntity> = Mockito.mock(Observer::class.java) as Observer<MoviesEntity>
//
...
//
//        Mockito.verify(movieRepository).getMoviesUpComing()
//
...
//        expectedResult.setValue(moviesEntity)
//
//        Mockito.`when`(movieRepository.getMoviesPopular())
//            .thenReturn(expectedResult)
//
//        val observer: Observer<MoviesEntity> = Mockito.mock(Observer::class.java) as Observer<MoviesEntity>
//
...
//
//        Mockito.verify(movieRepository).getMoviesPopular()
//
...
//        expectedResult.setValue(moviesEntity)
//
//        Mockito.`when`(movieRepository.getMoviesTopRated())
//            .thenReturn(expectedResult)
//
//        val observer: Observer<MoviesEntity> = Mockito.mock(Observer::class.java) as Observer<MoviesEntity>
//
...
//
//        Mockito.verify(movieRepository).getMoviesTopRated()
//
